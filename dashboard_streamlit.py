...
def train_models(df_model):
    ...
    # SARIMA Model
    price = df_model["DE_LU_price_day_ahead"].copy()
    price = price.asfreq("H")
    price = price.interpolate(method="time")

    train_sarima = price.loc[:"2020-06-30"]
    test_sarima = price.loc["2020-07-01":"2020-09-30"]
    ...
    return {
        ...
        'y_pred_sarima': y_pred_sarima, 'sarima': sarima_fit,
